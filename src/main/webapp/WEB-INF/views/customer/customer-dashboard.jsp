...
<head>
  ...
  <link rel="shortcut icon" href="vscode.ico" type="image/x-icon">
  <!-- Bootstrap CSS -->
...
<body class="container-fluid">
  <h1 class="text-primary text-center m-2">User Dashboard</h1>
 	<a 	href="<%=request.getContextPath() + UrlUtils.CUSTOMER_ADD %>" class="btn btn-primary text-white p-2 mb-3">Add new customer</a>
